...
from libs.contrib.guardian.exceptions import NotUserNorGroup
...
def get_user_obj_perms_model_class():
    return import_string("libs.contrib.guardian.models.UserObjectPermission")


def get_group_obj_perms_model_class():
    return import_string("libs.contrib.guardian.models.GroupObjectPermission")
